...
public class ConfigRegister {
    ...
    @Config.Comment("1.Please customize smeltings in the form of {domain:input, domain:output, acquirable_experience}.\n2.For example, {{minecraft:dirt, 1, 1}, {minecraft:dirt, 1, 2}, 0.5} #Smelt [Coarse Dirt(Dirt_1)] to [Podzol(Dirt_2)] acquiring 0.5 experience.")
    @Config.Name("Smeltings")
    public static String[] Smeltings = new String[] {
            "#Minecraft:Block.Decoration",
