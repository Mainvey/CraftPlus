    ...
    public ConfigRegister(FMLPreInitializationEvent event) {
        ...
        Recipes = config.get(
                ...
                new String[] {
                        ...
                        "{minecraft:chainmail_helmet, {&&&, &*&}, {&, craftplus:iron_bars}} #Compose [Chain Helmet] with 5x[Iron Bars] in &&&,& & form.",
                        "{minecraft:chainmail_chestplate, {&*&, &&&, &&&}, {&, craftplus:iron_bars}} #Compose [Chain Chest Plate] with 8x[Iron Bars] in & &,&&&,&&& form.",
                        "{minecraft:chainmail_leggings, {&&&, &*&, &*&}, {&, craftplus:iron_bars}} #Compose [Chain Leggings] with 7x[Iron Bars] in &&&,& &,& & form.",
                        "{minecraft:chainmail_boots, {&*&, &*&}, {&, craftplus:iron_bars}} #Compose [Chain Boots] with 4x[Iron Bars] in & &,& & form.",
        ...
        Smeltings = config.get(
                ...
                "1.Please customize smeltings in form of {domain:input, domain:output, acquirable_experience}.\n2.For example, {{minecraft:dirt, 1, 1}, {minecraft:dirt, 1, 2}, 0.5} #Smelt [Coarse Dirt(Dirt_1)] to [Podzol(Dirt_2)] and acquire 0.5 experience."
        ).getStringList();
